...
namespace TrySapper
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                if (live > 0)//сама игра идем пока есть жизни,
                {
                    Hit();
                    CheckTheWin();
        ...
        public static void CheckTheWin()// мето для подсчета удачных шагов
        {
            for (int i = 0; i < 5; i++)
            {
                for (int j = 0; j < 5; j++)
        ...
        public static void CheckTheCell(int StrHit,int ColumnHit)// проверка на повторы
        {
            for (int i = 0; i < 5; i++)
            {
                for (int j = 0; j < 5; j++)
                {
                    if (RealBombArray[i, j] == '0')
                    {
